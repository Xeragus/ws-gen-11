...
const coordinatesRouter = require('./routers/coordinates')
...
app.use('/weather', coordinatesRouter)

app.listen("3005", (error) => {
  if (error) {
    return console.log(
      "Error happened while starting the app on port 3005: ",
      error
    );
  }
  console.log("Weather service successfully started on port 3005");
});